...
public class Zombie extends ActionObject implements Moveable, Executable{
    public static final String ZOMBIE_KEY = "zombie";
    public static final int ZOMBIE_ANIMATION_PERIOD_IDX = 0;
    public static final int ZOMBIE_ACTION_PERIOD_IDX = 1;
    public static final int ZOMBIE_NUM_PROPERTIES = 2;
    private List<Point> currentPath = new ArrayList<>();

    public Zombie (String id, Point position, double actionPeriod, double animationPeriod, List<PImage> images) {
